...
import static com.ibm.bluemix.appid.cloud.directory.android.sample.appid.MainActivity.FORGOT_PASSWORD_SUCCESS;
...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    public void attemptForgotPassword(View v) {
        ...
        AppIDRequest request = appIDRequestFactory.createRequest(CLOUD_LAND_BACKEND_URL + "/forgot_password/submit/mobile", AppIDRequest.POST);
